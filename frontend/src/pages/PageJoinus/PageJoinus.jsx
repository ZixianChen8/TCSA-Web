                      ...
                      <>
                        ...
                        <div className={`${styles.benefitItem} ${styles.reverseOrder}`}>
                          <div className={styles.benefitTextContainer}>
                            ...
                            <p>
                              By joining TCSA, you can obtain an internship certificate issued by a federally registered Canadian company. This is not just a participation record, but a legitimate experience that can be added to your resume. For international students without local experience, this certificate serves as a powerful entry point into the Canadian job market.<br /><br />
                              加入 TCSA 后，你将有机会获得由加拿大联邦注册公司开具的实习证明。这不仅是一份普通的社团参与记录，而是能写进简历的“实习经历”。对于缺乏本地经验的国际学生来说，这是一份难得的职场入门通行证。
                            </p>
                          </div>
                          <div className={styles.benefitImageContainer}>
                        ...
                        <div className={styles.benefitItem}>
                          <div className={styles.benefitTextContainer}>
                            ...
                            <p>
                              TCSA connects you with talented peers, cross-disciplinary collaborators, local businesses, alumni, and industry mentors. These networking opportunities not only support your academic journey but can also open doors for internships, job placements, entrepreneurship, and graduate studies.<br /><br />
                              TCSA 为你提供结识优秀同学、跨专业合作的机会，同时也让你与本地企业、校友及行业导师建立联系。这些人脉网络不仅能带来学业上的帮助，更可能成为你未来求职、创业或深造的重要资源。
                            </p>
                          </div>
                          <div className={styles.benefitImageContainer}>
